...
function infinite_setup() {
	...
	add_theme_support( 'post-thumbnails' , array('post','page','msd_speaker'));
...
function infinite_widgets_init() {	
	...
	register_sidebar( array(
		'name' => __( 'Header Widget Area', 'infinite' ),
		'id' => 'header-right',
		'description' => __( 'The header right widget area', 'infinite' ),
...
function add_scripts() {
	if(!is_admin()){
		...
		wp_enqueue_script('equal-heights',get_bloginfo('template_url').'/js/equalHeights.jQuery.js',array('jquery'),NULL,TRUE);
		if (is_front_page()) {
